  ...
  <div class="main_o clearfix position-relative">
    ...
    <section id="center" class="center_about">
     ...
     <div class="row center_o1">
      <div class="col-md-12">
         <h2 class="text-white">Reservation</h2>
       <h6 class="mb-0 mt-3 fw-normal col_oran"><a class="text-light" href="index.html">Home</a> <span class="mx-2 col_light">/</span> Reservation</h6>
      </div>
     </div>
    </div>
      </div>
